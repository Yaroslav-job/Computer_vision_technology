...
public class ImageAPI {
    ...
    public ImageAPI() throws Exception {
        ...
        nativeLibraryPath = Paths.get(basePath, nativeLibraryPath).toAbsolutePath().toString();
    ...
    // Обнуление указанного канала изображения
    ...
    // Отображение изображения в графическом интерфейсе
